...
commands=(
    ...
    "cd ${WS_DIR} && source install/setup.bash && ros2 launch aruco_tracker downward_camera_aruco.launch.py"
    "cd ${WS_DIR} && source install/setup.bash && ros2 launch precision_land precision_land_auto.launch.py"
)
